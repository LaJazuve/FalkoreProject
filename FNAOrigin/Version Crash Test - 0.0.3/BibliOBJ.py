...
class Hero:
    ...
    def voir(self,dic):     
        ...
        for i in dic:
            ...
            if not hasattr(i,"pos_b"):
                ...
                liste.append(i.nom)###contourne le bug des portes
    ...
    def prendre(self,obj):
        ...
        if obj.port==True and obj.position==self.position:
            obj.position=("inventaire")
            print("vous avez mis ", obj.nom," dans votre sac.")

            
    def poser(self,obj):

        if obj.port==True and obj.position==("inventaire"):
            obj.position=self.position
            print ("vous avez posé ",obj.nom)
...
class Salle:
    ...
    def __init__(self,nom,description,vision):
...
class Porte:
    ...
    def __init__(self,nom,position,pos_b,lock):
